...
public class ChunkMeshOptimized : MonoBehaviour
{
    #region --- helper ---
    ...
    private class ChunkObject
    {
        ...
        public ChunkObject(int x, int y, int z)
        {
    ...
    private void Start()
    {
        chunkobject = new ChunkObject((int)chunksize.x, (int)chunksize.y, (int)chunksize.z);
